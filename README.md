...
- Organize your favorite movies
  ...
  - look back at Atom and edit that text file with a description of the character's role in the movie
...
You can open up your "my-favorite-things" directory in Atom, to track your progress. You can also use `tree`.
